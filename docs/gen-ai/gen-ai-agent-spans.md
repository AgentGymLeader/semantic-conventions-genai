...
| [`gen_ai.agent.decision.outcome`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If `gen_ai.agent.decision.id` is set. | string | The observed result of a governance decision on an action the agent attempted. [10] | `allow`; `block`; `review`; `escalate`; `defer` |
...
| [`server.address`](https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [16] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`gen_ai.agent.decision.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Opaque, producer-defined identifier correlating telemetry with a single governance decision point for the agent. [17] | `decision_01J8Z3K5G4QYX9V2XQ9K7YXTAM` |
| [`gen_ai.agent.governance.ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Opaque, producer-defined reference to producer-owned governance context for a decision point, for example a policy, approval, or execution-context record. [18] | `ctx_7f3a9c` |
...
**[17] `gen_ai.agent.decision.id`:** The value has no meaning to the convention beyond identity; consumers use it only to join telemetry with the producer's own record of that decision. This attribute exists only where a decision point was reached and an action was attempted. It does not indicate, and MUST NOT be used to indicate, whether any other action was or was not available to the agent.

**[18] `gen_ai.agent.governance.ref`:** The referenced record's format, schema, lifecycle, and validation behavior are implementation-defined and out of scope for this convention. This attribute defines only a payload-free join surface; it does not carry the referenced record's contents.
...
**[22] `gen_ai.tool.definitions`:** Since this attribute could be large, it's NOT RECOMMENDED to populate
...
| [`gen_ai.request.choice.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If available, in the request, and !=1. | int | The target number of candidate completions to return. | `3` |
| [`gen_ai.request.seed`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If applicable and if the request includes a seed. | int | Requests with same seed value more likely to return same result. | `100` |
| [`gen_ai.agent.decision.outcome`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If `gen_ai.agent.decision.id` is set. | string | The observed result of a governance decision on an action the agent attempted. [7] | `allow`; `block`; `review`; `escalate`; `defer` |
| [`gen_ai.request.frequency_penalty`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | double | The frequency penalty setting for the GenAI request. | `0.1` |
| [`gen_ai.request.max_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The maximum number of tokens the model generates for a request. | `100` |
...
| [`gen_ai.agent.decision.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Opaque, producer-defined identifier correlating telemetry with a single governance decision point for the agent. [13] | `decision_01J8Z3K5G4QYX9V2XQ9K7YXTAM` |
| [`gen_ai.agent.governance.ref`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Opaque, producer-defined reference to producer-owned governance context for a decision point, for example a policy, approval, or execution-context record. [14] | `ctx_7f3a9c` |
...
| [`gen_ai.tool.definitions`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The list of tool definitions available to the GenAI agent or model. [18] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "function",<br>&nbsp;&nbsp;&nbsp;&nbsp;"name": "get_current_weather",<br>&nbsp;&nbsp;&nbsp;&nbsp;"description": "Get the current weather in a given location",<br>&nbsp;&nbsp;&nbsp;&nbsp;"parameters": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "object",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"properties": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"description": "The city and state, e.g. San Francisco, CA"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unit": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"enum": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"celsius",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"fahrenheit"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"required": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unit"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;}<br>] |
...
**[7] `gen_ai.agent.decision.outcome`:** This attribute describes the outcome of a resolved attempt only. Whether an action was ever available to the agent in the first place is a separate producer-side concern and is intentionally out of scope for this attribute and this convention; this attribute has no such member.
...
**[13] `gen_ai.agent.decision.id`:** The value has no meaning to the convention beyond identity; consumers use it only to join telemetry with the producer's own record of that decision. This attribute exists only where a decision point was reached and an action was attempted. It does not indicate, and MUST NOT be used to indicate, whether any other action was or was not available to the agent.

**[14] `gen_ai.agent.governance.ref`:** The referenced record's format, schema, lifecycle, and validation behavior are implementation-defined and out of scope for this convention. This attribute defines only a payload-free join surface; it does not carry the referenced record's contents.

**[15] `gen_ai.input.messages`:** Messages MUST be provided in the order they were sent to the model.
Instrumentations MAY provide a way for users to filter or truncate
input messages.
...
**[18] `gen_ai.tool.definitions`:** Since this attribute could be large, it's NOT RECOMMENDED to populate
non-required properties by default. Instrumentations MAY provide a way
to enable populating optional properties.
