...
| [Add gen_ai.agent.request.size and gen_ai.agent.response.size metrics (#202)](https://github.com/open-telemetry/semantic-conventions-genai/pull/202) | pvlsirotkin | Copilot&nbsp;💬<br>lmolkova&nbsp;💬<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ✅ | 6d |
...
| [semconv for a2a protocol (#195)](https://github.com/open-telemetry/semantic-conventions-genai/pull/195) | eternalcuriouslearner | aabmass<br>JWinermaSplunk<br>trask | ✅ | ❌ | 21h |
| [Add `gen_ai.agent.finish_reason` attribute for agent loop termination (#238)](https://github.com/open-telemetry/semantic-conventions-genai/pull/238) | Nik-Reddy | aabmass&nbsp;✅<br>Copilot&nbsp;💬<br>MikeGoldsmith&nbsp;✅<br>trask | ✅ | ❌ | 19h |
| [gen-ai: add run guardrail span and security finding (#262)](https://github.com/open-telemetry/semantic-conventions-genai/pull/262) | nagkumar91 | aabmass<br>Copilot&nbsp;💬 | ✅ | ❌ | 16h |
| [Propose GenAI agent entity (#270)](https://github.com/open-telemetry/semantic-conventions-genai/pull/270) | aabmass | Copilot&nbsp;💬<br>lmolkova | ✅ | ✅ | 13h |
| [Add Towncrier changelog management (#275)](https://github.com/open-telemetry/semantic-conventions-genai/pull/275) | trask | lmolkova&nbsp;💬⁠✅ | ✅ | ✅ | 9h |
...
```text
PR #275
llm: PRRT_kwDOSUeMrM6IWwSk -> author (A reviewer asked for documentation changes in the PR, so the author needs to update the instructions and reply.)
...
PR #238
llm: PRRT_kwDOSUeMrM6IPOxu -> author (The reviewer asked for a new reference scenario to exercise `gen_ai.agent.finish_reason="guardrail"`, so the PR author needs to implement that change.)
llm: pr-conversation -> none (The reviewer answered the author’s scope question with agreement and no follow-up request, so the discussion appears complete.)
