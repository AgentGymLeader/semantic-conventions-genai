...
|---|---|---|:---:|:---:|:---:|
| [Generalize the `gen_ai.provider.name` description (#212)](https://github.com/open-telemetry/semantic-conventions-genai/pull/212) ✅✅ | trask |  | ✅ | ✅ | 4h |
| [Clarify that billed token counts should be reported for Cohere usage (#211)](https://github.com/open-telemetry/semantic-conventions-genai/pull/211) ✅✅ | trask |  | ✅ | ✅ | 4h |
...
| [Normalize requirement-level condition notes to capitalized sentences (#245)](https://github.com/open-telemetry/semantic-conventions-genai/pull/245) | trask |  | ✅ | ✅ | 4h |
...
| [Limit gen_ai.agent.id to stable / static identifiers (#242)](https://github.com/open-telemetry/semantic-conventions-genai/pull/242) | lmolkova |  | ✅ | ❌ | 15h |
...
| [Add gen_ai.agent.request.size and gen_ai.agent.response.size metrics (#202)](https://github.com/open-telemetry/semantic-conventions-genai/pull/202) | pvlsirotkin |  | ✅ | ✅ | 6h |
...
| [Route approved PRs with a pending reviewer thread to Waiting on approvers (#248)](https://github.com/open-telemetry/semantic-conventions-genai/pull/248) | trask | 48m |
...
PR #215
llm: PRRT_kwDOSUeMrM6Fl7mu -> author (The latest comment is from a reviewer proposing an option and asking for the naming/metric split to be decided, so the PR author needs to respond or implement the chosen approach.)
