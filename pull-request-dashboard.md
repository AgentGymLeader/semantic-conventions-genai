...
| [Add experimental GenAI context selection event (#190)](https://github.com/open-telemetry/semantic-conventions-genai/pull/190) | caioribeiroclw-pixel |  | ❌ | ✅ | 21h |
| [Add prompt versioning and variable support to GenAI attributes (#179)](https://github.com/open-telemetry/semantic-conventions-genai/pull/179) | steverao |  | ✅ | ✅ | 19h |
...
| [chore: add moonshot_ai to well-known values (#99)](https://github.com/open-telemetry/semantic-conventions-genai/pull/99) | ariesdevil |  | ✅ | ✅ | 2h |
| [Add Copilot review guidance workflow (#193)](https://github.com/open-telemetry/semantic-conventions-genai/pull/193) | trask |  | ✅ | ✅ | 2m |
...
```text
PR #193
llm: PRRT_kwDOSUeMrM6EU6EQ -> author (The reviewer reported a formatting issue and asked for a change to the workflow heredoc, so the PR author needs to update the file.)
llm: PRRT_kwDOSUeMrM6EU6Ec -> author (A reviewer requested an explicit low `retention-days` setting, so the PR author needs to address or जवाब to the suggestion.)
