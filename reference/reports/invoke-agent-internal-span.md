...
| --- | --- |
| gen_ai.operation.name | [agent-framework], [agent-governance], [autogen], [crewai], [google-adk], [openai-agents], [pydantic-ai] |
...
| gen_ai.agent.name | [agent-framework], [agent-governance], [autogen], [crewai], [google-adk], [openai-agents], [pydantic-ai] |
